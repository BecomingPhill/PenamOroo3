...
/**
 * Created by Highfather87 on 10/11/15.
 */
...
public class MotionViewsActivity extends Activity  {
    ...
    public static String TAG = MotionViewsActivity.class.getSimpleName();
    ...
    private Button m_btnSelectImage, m_btnSDeleteImage, m_btnZoom, btn_save;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_btnSelectImage.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void getImageLayout(Bitmap p_bitmap) {
        ...
        m_ivtmpImage.setImageBitmap(Bitmap.createScaledBitmap(p_bitmap, 400, 400,
                true));
        ...
        if (m_absHeight >= 900)
            m_ivtmpImage
                    .setLayoutParams(new FrameLayout.LayoutParams(400, 400));
        else
            m_ivtmpImage.setLayoutParams(new FrameLayout.LayoutParams(300, 300));
    ...
    public void SaveScreenShot(View view){
        ...
        //shows the button id which is 0 for all currently
        /*String mouth = String.valueOf(m_btnZoom.getId());
        Toast unsavedToast1 = Toast.makeText(getApplicationContext(),
                mouth, Toast.LENGTH_SHORT);
        unsavedToast1.show();*/
        m_btnZoom.setId(0);
        m_btnSDeleteImage.setId(0);
        m_absZoomlayout.setId(0);

        m_btnSDeleteImage.setBackgroundResource(0);
        m_btnZoom.setBackgroundResource(0);
        m_absZoomlayout.setBackgroundResource(0);
        ...
        // MediaStore.Images.Media.insertImage(getContentResolver(), bitmap, "Oroo" ,"");
        //store(bitmap, "File");
        File file;
            /*String imgSaved = MediaStore.Images.Media.insertImage(
                    getContentResolver(),drawView.getDrawingCache(),UUID.randomUUID().toString()+".jpg","drawing");*/
        String root = Environment.getExternalStorageDirectory().toString();
        File myDir = new File(root + "/PenanOroo/Saved signs");
        myDir.mkdirs();
        String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
        String fname = "Oroo_" + timeStamp + ".jpg";
        ...
        finish();
        Toast.makeText(this, "Your Oroo sign was successfully saved", Toast.LENGTH_LONG).show();
